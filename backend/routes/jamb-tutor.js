...
router.post('/', async (req, res) => {
  try {
    ...
    if (retrievedQuestion) {
      ...
      prompt = `You are a world-class JAMB UTME tutor. A student has asked for a specific past question.
...
4. Maintain an encouraging and helpful tone.`;
      ...
      prompt = `You are a world-class JAMB UTME tutor. The user asked: "${userQuery}".
...
- Maintain a helpful and conversational tone.`;
    ...
    console.error("Error in JAMB Tutor:", error);
    res.status(500).json({
